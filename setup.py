...
plugin_identifier = "internal_slicer"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_internal_slicer"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Internal_Slicer"
...
plugin_author = "Garrett Broters, based on work by Kenneth Jiang"
...
plugin_requires = ["OctoPrint>=1.6.0"]
